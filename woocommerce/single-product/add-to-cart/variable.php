	...
	<table class="position-relative table table-bordered variations" cellspacing="0">
		<tbody>
			...
			<tr class="variations__item">
				<th class="variations__item-label"><label for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php echo wc_attribute_label( $attribute_name ); // WPCS: XSS ok. ?></label></th>
				<td class="variations__item-value">
					<?php
						...
						echo end( $attribute_keys ) === $attribute_name ? wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations position-absolute" href="#">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) ) : '';
					?>
				</td>
			</tr>
			<?php endforeach; ?>
