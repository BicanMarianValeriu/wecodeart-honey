				...
				foreach ( $order->get_order_item_totals() as $key => $total ) {
					?>
						<tr>
							...
							<td class="has-text-align-right"><?php echo ( 'payment_method' === $key ) ? esc_html( $total['value'] ) : wp_kses_post( $total['value'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></td>
						</tr>
						<?php
				}
				?>
