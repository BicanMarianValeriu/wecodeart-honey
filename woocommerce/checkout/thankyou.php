...
<div class="woocommerce-order col-md-10 col-lg-8 mx-auto"><?php
	if ( $order ) :
	...
	<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details grid list-unstyled mb-5" style="--wp--columns:4;">
		...
		<li class="woocommerce-order-overview__payment-method method card card-body span-4 span-md-2 span-lg-1">
