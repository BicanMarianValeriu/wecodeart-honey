...
/* harmony import */ var _routes_archive_changelog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./routes/archive-changelog */ "./src/js/routes/archive-changelog/index.js");
/* harmony import */ var _routes_single_changelog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./routes/single-changelog */ "./src/js/routes/single-changelog/index.js");
/* harmony import */ var _routes_single_document__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./routes/single-document */ "./src/js/routes/single-document/index.js");
/**
  ...
  ...{
    ...
    routes: {
      ...
      postTypeArchiveChangelog: {
        complete: _routes_archive_changelog__WEBPACK_IMPORTED_MODULE_4__["default"]
      },
      singleChangelog: {
        init: _routes_single_changelog__WEBPACK_IMPORTED_MODULE_5__["default"],
        extends: ['post-type-archive-changelog']
      },
      singleDocument: {
        init: _routes_single_document__WEBPACK_IMPORTED_MODULE_6__["default"],
        extends: ['home']
      }
    }
  }
...
/***/ "./src/js/plugins/wecodeart-Search.js":
/*!********************************************!*\
  !*** ./src/js/plugins/wecodeart-Search.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./src/js/routes/archive-changelog/index.js":
/*!**************************************************!*\
  !*** ./src/js/routes/archive-changelog/index.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  new bootstrap_js_dist_scrollspy__WEBPACK_IMPORTED_MODULE_0___default.a(document.body, {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _plugins_wecodeart_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../plugins/wecodeart-Search */ "./src/js/plugins/wecodeart-Search.js");
...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./icons */ "./src/js/routes/common/icons/index.js");
// Deps
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  init: () => {
    ...
    _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_1__["library"].add(_icons__WEBPACK_IMPORTED_MODULE_3__["default"]);
  },
  complete: () => {
    // Tooltips
    const tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));
    tooltipTriggerList.map(tooltipTriggerEl => new bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_2___default.a(tooltipTriggerEl)); // LazyInit Search

    const searchPlugin = document.querySelector('[data-plugin-live-search]');
    wecodeart.plugins.LiveSearch.init(searchPlugin); // Icons

    _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_1__["dom"].watch(); // Select2
...
/***/ "./src/js/routes/single-changelog/index.js":
/*!*************************************************!*\
  !*** ./src/js/routes/single-changelog/index.js ***!
  \*************************************************/
/*! exports provided: default */
...
/***/ "./src/js/routes/single-document/handleFeedback.js":
/*!*********************************************************!*\
  !*** ./src/js/routes/single-document/handleFeedback.js ***!
  \*********************************************************/
/*! exports provided: default */
  ...
  function handleFeedback(e) {
    ...
    return fetch(ajaxUrl, {
      ...
      if (meta && parseInt(meta[this.dataset.type])) {
        const instance = bootstrap_js_dist_tooltip__WEBPACK_IMPORTED_MODULE_1___default.a.getInstance(this);
        instance.hide();
        const value = meta[this.dataset.type].toString(); // Update tooltip text

        const newTooltip = this.dataset.bsOriginalTitle.replace(/\d/g, value);
        this.setAttribute('data-bs-original-title', newTooltip); // Update tooltip badge

        const likesCount = this.querySelector('.badge');
        if (likesCount) likesCount.innerText = value; // Update meta count
      ...
      const feedbackToast = new bootstrap_js_dist_toast__WEBPACK_IMPORTED_MODULE_0___default.a(feedbackEl);
      feedbackToast.show();
      isLoading = false;
    });
  }
...
/***/ "./src/js/routes/single-document/handleNavigation.js":
/*!***********************************************************!*\
  !*** ./src/js/routes/single-document/handleNavigation.js ***!
  \***********************************************************/
/*! exports provided: default */
...
/***/ "./src/js/routes/single-document/index.js":
/*!************************************************!*\
  !*** ./src/js/routes/single-document/index.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _handleFeedback__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./handleFeedback */ "./src/js/routes/single-document/handleFeedback.js");
/* harmony import */ var _handleNavigation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handleNavigation */ "./src/js/routes/single-document/handleNavigation.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  Object(_handleNavigation__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_handleFeedback__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
