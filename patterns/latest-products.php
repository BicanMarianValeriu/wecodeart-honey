...
<div class="wp-block-group py-5">
    ...
    <h4 class="has-text-align-center mb-0 has-primary-color has-text-color" id="blog-ul-nostru">Ultimele</h4>
    <!-- /wp:heading -->
    <!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0"}}},"textColor":"dark","className":"h1"} -->
    <h2 class="wp-block-heading has-text-align-center h1 has-dark-color has-text-color" id="ultimele-bunatati" style="margin-top:0">Bunătăți</h2>
    <!-- /wp:heading -->
